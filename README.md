[![shellcheck](https://github.com/markdown-localization/mdlm-sh/workflows/shellcheck/badge.svg)](https://github.com/voitau/mdlm-sh/actions?query=workflow:shellcheck)
